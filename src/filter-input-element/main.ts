...
class FilterInputElement extends HTMLElement {
  ...
  constructor() {
    ...
    this.filter = null
    this.debouceInputChange = debounce(() => filterResults(this, true))
  ...
  connectedCallback() {
    ...
    input.addEventListener('input', this.debouceInputChange)
  }
  ...
  disconnectedCallback() {
    ...
    input.removeEventListener('input', this.debouceInputChange)
  }
